...
public abstract class Animal {
     ...
     * exactamente 5 caracteres que sean dígitos (0-9) o letras minúsculas
     * (a-z). - El sexo debe ser 'M' (hembra) o 'H' (macho). - El peso debe ser
     * un valor positivo mayor que cero. - La fecha de nacimiento debe estar en
     * formato ISO-8601 (yyyy-MM-dd) válido.
     *
     ...
     * sexo es incorrecto, el peso no es positivo o la fecha no tiene un formato
     * válido
     */
